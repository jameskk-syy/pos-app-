...
import 'package:pos/screens/sales/create_pos_profile.dart';
import 'package:pos/screens/finance/payment_methods_page.dart';
import 'package:pos/widgets/users/change_password_dialog.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                ProfileMenuCard(
                  ...
                  title: "Pos Profile",
                  subTitle: "create pos profile to start making sales",
                  press: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context2) => CreatePosProfilePage(),
                      ),
                    );
                  },
                ),
                ...
                ProfileMenuCard(
                  ...
                  press: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context2) => const PaymentMethodsPage(),
                      ),
                    );
                  },
                ),
                ...
                ProfileMenuCard(
                  svgSrc: shareIconSvg,
                  title: "Offline Sync",
                  subTitle: "Sync offline transactions",
                  press: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context2) => const SyncPage(),
                      ),
                    );
                  },
                ),
            ...
            children: [
              SvgPicture.string(
                ...
                colorFilter: ColorFilter.mode(
                  const Color(0xFF010F07).withAlpha(64),
                  BlendMode.srcIn,
                ),
              ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        color: const Color(0xFF010F07).withAlpha(54),
                      ),
                    ),
                  ],
                ),
