...
class _ProductsGridPageState extends State<ProductsGridPage> {
  ...
  Future<void> _loadProductsAndCart() async {
    try {
      ...
      final productsData = await storage.getString('productsData');
      ...
      final cartData = await storage.getString('cart_items');
      if (cartData != null) {
  ...
  Future<void> _saveCartToPrefs() async {
    try {
      ...
      await storage.setString('cart_items', jsonEncode(cartData));
    } catch (e) {
