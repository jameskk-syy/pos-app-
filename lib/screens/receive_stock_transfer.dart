...
class _StockReceiveStockScreenState
    extends State<StockReceiveStockScreen> {
    ...
    if (_items.isEmpty) {
      _items = data.items.map((item) {
        return <String, dynamic>{
          ...
          'received_qty': item.dispatchedQty,
        };
      }).toList();
    }
  }

  Future<void> _handleReceive(String requestId, String destinationWarehouse) async {
    ...
    context.read<InventoryBloc>().add(
      ReceiveStock(request: receiveRequest),
    );
  }
