...
import 'package:pos/screens/products/items_seed.dart';
...
class _BussinessTypePageState extends State<BussinessTypePage> {
  ...
  String industryType = "";
  String? _selectedIndustryCode;

  Future<void> _loadSelectedIndustry() async {
    try {
      final storage = getIt<StorageService>();
      final currentUserJson = await storage.getString('current_user');
      ...
      debugPrint('Error loading selected industry: $e');
    }
  }
