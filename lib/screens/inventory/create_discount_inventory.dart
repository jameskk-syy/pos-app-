...
import 'package:pos/screens/inventory/widgets/discount_rule_form_widgets.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              RuleSpecificFields(
                                ...
                                onItemGroupChanged: (v) =>
                                    setState(() => selectedItemGroup = v),
                              ),
                              const SizedBox(height: 24),
                              DiscountValueSection(
                                selectedDiscountType: selectedDiscountType,
                                valueController: discountValueController,
                                onTypeChanged: (v) {
                                  setState(() {
                        ...
                        Container(
                          ...
                          child: AdditionalSettingsSection(
                            validFrom: validFromDate,
                            validUpto: validUptoDate,
                            onSelectFromDate: () => _selectDate(context, true),
                            onSelectUptoDate: () => _selectDate(context, false),
                            descriptionController: descriptionController,
                            isActive: isActive,
                            onStatusChanged: (v) => setState(() => isActive = v),
                          ),
                        ),
