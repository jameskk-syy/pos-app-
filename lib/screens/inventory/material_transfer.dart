...
class _MaterialTransferPageState extends State<MaterialTransferPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => getIt<StoreBloc>()
        ..add(GetAllStores(company: currentUserResponse!.message.company.name)),
      child: Scaffold(
          ...
          actions: [
            Padding(
              ...
              child: ElevatedButton.icon(
                onPressed: () async {
                  final result = await _showCreateTransferForm(context);
                  if (result == true) {
                    setState(() {});
                  }
                },
  ...
  Future<bool?> _showCreateTransferForm(BuildContext context) {
