...
import 'package:pos/screens/create_discount_inventory.dart';
...
class _InventoryDiscountRulesScreenState
  ...
  final List<String> _ruleTypeOptions = [
    'Item',
    'Batch',
    'Item Group',
  ];

  final List<String> _discountTypeOptions = [
    'Amount',
    'Percentage',
  ];
