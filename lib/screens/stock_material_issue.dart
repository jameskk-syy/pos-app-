...
class _MaterialIssuePageState extends State<MaterialIssuePage> {
  ...
  Widget _bottomButtons() {
    return BlocBuilder<InventoryBloc, InventoryState>(
      builder: (context, state) {
        final isLoading = state is CreateMaterialIssueLoading;
            ...
            children: [
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: isLoading ? null : _submitMaterialIssue,
  ...
  void _submitMaterialIssue() {
    ...
    if (items.any((item) => item.purpose.isEmpty)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Please enter purpose for all items')),
      );
      return;
    }
