...
import 'package:pos/screens/create_products.dart';
import 'package:pos/widgets/edit_product_sheet.dart';
import 'package:pos/widgets/manage_barcode_sheet.dart';
import 'package:pos/widgets/manage_price_sheet.dart';
import 'package:pos/widgets/product_details_dialog.dart';
import 'package:pos/widgets/products_list.dart';
...
class _ProductManagementPageState extends State<ProductManagementPage> {
  ...
  Future<void> _navigateToManagePrice(ProductItem product) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => ManagePricePage(product: product),
      ),
    );
        ...
        body: BlocListener<ProductsBloc, ProductsState>(
          listener: (context, state) {
            if (state is ProductsCreateStateSuccess ||
              ...
              setState(() {
                _isLoading = false;
                final newProducts = state.productResponseSimple.products;
...
class ManagePricePage extends StatelessWidget {
  ...
  const ManagePricePage({super.key, required this.product});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ManagePriceSheet(product: product),
    );
  }
}
