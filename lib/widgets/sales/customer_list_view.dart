...
import 'package:pos/widgets/crm/assign_loyalty_program.dart';
import 'package:pos/widgets/sales/credit_management_modal.dart';
import 'package:pos/widgets/crm/points_widget_dialog.dart';
  ...
  void _onMenuItemSelected(String value, Customer customer) {
    switch (value) {
      ...
      case 'view_point_history':
        ...
        break;
      case 'manage_credit':
        _showCreditManagementDialog(customer);
        break;
    }
  }

  Future<void> _showCreditManagementDialog(Customer customer) async {
    final crmBloc = context.read<CrmBloc>();
    await showDialog(
      context: context,
      builder: (context) => BlocProvider.value(
        value: crmBloc,
        child: CreditManagementModal(customer: customer),
      ),
    );
  }
                        ...
                        child: PopupMenuButton<String>(
                          ...
                          itemBuilder: (BuildContext context) => [
                            ...
                            const PopupMenuItem(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.credit_score, size: 20),
                                  SizedBox(width: 8),
                                  Text('Manage Credit'),
                                ],
                              ),
