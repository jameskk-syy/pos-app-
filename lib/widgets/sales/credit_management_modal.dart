...
class CreditManagementModal extends StatefulWidget {
  ...
  const CreditManagementModal({super.key, required this.customer});
          ...
          return Dialog(
            ...
            child: Container(
              ...
              constraints: BoxConstraints(
                maxHeight: isSmallScreen ? constraints.maxHeight * 0.9 : 700,
              ),
...
class _CreditFormContent extends StatefulWidget {
  ...
  const _CreditFormContent({required this.customer, this.currentUserResponse});
...
class _CreditFormContentState extends State<_CreditFormContent> {
        ...
        Column(
          children: [
            Row(
              children: [
                Expanded(
                  child: _buildActionChip('Adjust Limit', Icons.tune, 'adjust'),
                ),
                const SizedBox(width: 12),
              ],
            ),
  ...
  Widget _buildActionChip(String label, IconData icon, String value) {
                    ...
                    context.read<CrmBloc>().add(
                      UpdateCreditLimit(
                        request: UpdateCreditLimitRequest(
                          ...
                          company:
                              widget.currentUserResponse!.message.company.name,
