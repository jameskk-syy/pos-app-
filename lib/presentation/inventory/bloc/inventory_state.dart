...
final class UpdateDiscountRuleLoading extends InventoryState {}

final class UpdateDiscountRuleSuccess extends InventoryState {
  final UpdateDiscountRuleResponse response;
  UpdateDiscountRuleSuccess(this.response);
}

final class UpdateDiscountRuleError extends InventoryState {
  final String message;
  UpdateDiscountRuleError(this.message);
}

final class DisableDiscountRuleLoading extends InventoryState {}

final class DisableDiscountRuleSuccess extends InventoryState {
  final DisableDiscountRuleResponse response;
  DisableDiscountRuleSuccess(this.response);
}

final class DisableDiscountRuleError extends InventoryState {
  final String message;
  DisableDiscountRuleError(this.message);
}

final class EnableDiscountRuleLoading extends InventoryState {}

final class EnableDiscountRuleSuccess extends InventoryState {
  final EnableDiscountRuleResponse response;
  EnableDiscountRuleSuccess(this.response);
}

final class EnableDiscountRuleError extends InventoryState {
  final String message;
  EnableDiscountRuleError(this.message);
}
